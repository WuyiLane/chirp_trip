...
11. **首页**：状态栏留白，「今日推荐」吸顶，滚到底上拉加载下一页；底栏是 iOS 26 式悬浮毛玻璃胶囊，选中态是一片中性色玻璃药丸（再模糊 + 高光渐变 + 亮边 + 软阴影）滑过去（途中拉长再缩回），选中项在图标下展开文字标签 —— `pages/home/home_page.dart` / `widgets/chick_tab_bar.dart`
